        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <form noValidate onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 flex flex-col justify-center">
            <div className="flex flex-col items-center gap-2 text-center mb-6">
              <h1 className="text-2xl font-bold text-gray-900 uppercase">Đăng ký</h1>
              <p className="text-sm text-gray-500">
                Tham gia cộng đồng nông sản sạch PixelMart
              </p>
            </div>
            ...
            <div className="space-y-3.5">
              ...
              <div className="flex items-start gap-2">
                ...
                />
                <Label htmlFor="terms" className="text-xs text-gray-600 font-normal cursor-pointer select-none">
                  Tôi đồng ý với{' '}
                  <a href="#" className="text-primary hover:underline">Điều khoản</a>
                  {' '}và{' '}
                  <a href="#" className="text-primary hover:underline">Bảo mật</a>
                </Label>
              </div>
              ...
              <div className="relative flex items-center justify-center my-4">
                ...
                <span className="relative px-3 bg-white text-xs text-gray-400 uppercase">Hoặc đăng ký với</span>
              </div>
              ...
              <p className="text-center mt-4 text-xs text-gray-500">
                Đã có tài khoản?{' '}
                <Link to="/login" className="text-primary hover:underline hover:text-primary-hover font-semibold">
                  Đăng nhập ngay
                </Link>
              </p>
            </div>
          ...
          <div className="relative hidden bg-slate-50 md:block">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/60 flex flex-col justify-end p-8 text-white">
              ...
              <p className="text-sm text-white/90 mt-1">Khám phá các sản phẩm đạt chứng nhận OCOP xuất sắc.</p>
            </div>
          </div>
        </CardContent>
      </Card>
