  ...
  return (
    <section className="w-full min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-sm overflow-hidden">
        {/* Header gradient */}
        <div className="bg-gradient-to-r from-primary to-green-400 py-16 px-8 text-center text-white">
        ...
        <div className="flex flex-col items-center justify-center text-center py-10 px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <Link
              to="/"
              className="inline-flex items-center gap-2 bg-primary text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-primary-hover transition-colors duration-200"
            >
              <Home size={16} />
              Về trang chủ
            </Link>
