...
class AuthService {
  async register(data: Partial<IUser> & { firstName?: string; lastName?: string }) {
  ...
  async googleLogin(googleId: string, email: string, firstName: string, lastName: string, avatar?: string) {
