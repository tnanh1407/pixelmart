...
router.patch("/profile", auth, asyncHandler(userController.updateProfile.bind(userController)));

router.post("/addresses", auth, asyncHandler(userController.addAddress.bind(userController)));
router.put("/addresses/:addressId", auth, asyncHandler(userController.updateAddress.bind(userController)));
