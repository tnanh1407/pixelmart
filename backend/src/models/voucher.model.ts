...
export type VoucherScope = (typeof VOUCHER_SCOPE)[keyof typeof VOUCHER_SCOPE];
...
const voucherSchema = new mongoose.Schema<IVoucherDocument>(
  {
    _id: {
      type: String,
      default: uuidv4,
...
const Voucher = mongoose.model<IVoucherDocument>("Voucher", voucherSchema);
