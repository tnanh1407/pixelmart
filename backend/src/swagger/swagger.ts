...
import { userSchemas } from "./user.swagger.js";
...
const options: swaggerJsdoc.Options = {
  ...
  apis: isProduction
    ? [path.join(__dirname, "../routes/v1/*.routes.js"), path.join(__dirname, "*.swagger.js")]
    : ["./src/routes/v1/*.routes.ts", "./src/swagger/*.swagger.ts"],
};
